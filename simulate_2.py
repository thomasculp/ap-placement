...
random_clusters_results = placement.simulate_2(repeat, arrays.random_clusters)
print('starting future results...')
future_results = placement.simulate_2(repeat, arrays.future)
print('starting office hours...')
office_hours_results = placement.simulate_2(repeat, arrays.office_hours)
