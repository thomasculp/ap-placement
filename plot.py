...
plt.plot([-1.5] * 5, '#d1d3d6', label='2 ROUTERS, fixed placement, office')
plt.plot([-0.1] * 5, '#404449', label='2 ROUTERS, fixed placement, office, WIFI')
...
plt.plot([0.0011] * 5, '#d1d3d6', label='2 ROUTERS, fixed placement, office')
plt.plot([0.00011] * 5, '#404449', label='2 ROUTERS, fixed placement, office, WIFI')
plt.xlabel('Number of Routers')
